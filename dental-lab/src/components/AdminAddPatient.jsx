      ...
      <main className="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <header className="flex justify-between items-center px-lg py-sm w-full sticky top-0 z-40 bg-surface-container-lowest border-b border-outline-variant">
          <div className="flex items-center gap-lg flex-1">
            <h2 className="font-headline-md text-headline-md font-semibold text-primary">Add New Patient</h2>
          ...
          <div className="p-lg max-w-[1600px] mx-auto">
            ...
            <div className="mb-xl flex flex-col md:flex-row md:items-end justify-between gap-md">
              <div>
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mt-xs">Register a new patient into the DentaLink Pro ecosystem to begin case management.</p>
              </div>
              <div className="flex gap-md">
                <Link to="/admin/patients" className="px-lg py-md rounded-lg border border-outline text-on-surface font-title-sm text-title-sm hover:bg-surface-container-low transition-colors duration-200">
                  Cancel
                </Link>
              ...
              <div className="lg:col-span-8 bg-surface-container-lowest border border-outline-variant rounded-xl p-xl">
                <form className="space-y-xl">
                  ...
                  <div className="flex md:hidden flex-col gap-md pt-lg">
                    ...
                    <Link to="/admin/patients" className="w-full py-md rounded-lg border border-outline text-on-surface font-title-sm text-title-sm text-center">Cancel</Link>
                  </div>
                </form>
              </div>
