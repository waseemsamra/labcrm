...
export default function AddSupplierModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-on-background/40 backdrop-blur-sm z-[60] flex items-center justify-center p-md">
      <div className="bg-white w-full max-w-[1200px] rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[900px]">
        {/* Header */}
        <header className="flex justify-between items-center px-lg py-lg border-b border-outline-variant bg-surface-container-lowest shrink-0">
