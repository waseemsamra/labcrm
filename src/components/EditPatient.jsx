      ...
      <div className="flex-grow p-lg">
        ...
        <div className="mb-xl flex flex-col md:flex-row md:items-end justify-between gap-md">
          ...
          <div className="flex gap-md">
            <Link to={`/client/PatientRecords/${patientId}`} className="px-lg py-md rounded-lg border border-outline text-on-surface font-title-sm text-title-sm hover:bg-surface-container-low transition-colors duration-200">
              Cancel
            </Link>
          ...
          <div className="lg:col-span-8 bg-surface-container-lowest border border-outline-variant rounded-xl p-xl">
            <form className="space-y-xl">
              ...
              <div className="flex md:hidden flex-col gap-md pt-lg">
                ...
                <Link to={`/client/PatientRecords/${patientId}`} className="w-full py-md rounded-lg border border-outline text-on-surface font-title-sm text-title-sm text-center">Cancel</Link>
              </div>
            </form>
          </div>
