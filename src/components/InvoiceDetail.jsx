    ...
    <div className="flex-1 flex flex-col h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto custom-scrollbar p-lg">
        ...
        <div className="flex items-center space-x-2 mb-6 text-on-surface-variant">
          <a href="/billing" className="flex items-center hover:text-primary transition-colors">
            ...
            <div className="bg-surface border border-outline-variant rounded-xl p-lg shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button className="p-2 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-colors border border-outline-variant">
