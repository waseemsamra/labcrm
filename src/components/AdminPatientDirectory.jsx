...
export default function AdminPatientDirectory() {
  const navigate = useNavigate()

  const rows = [
    { id: 'DP-8821', avatar: 'EH', avatarColor: 'bg-primary-container text-on-primary-container', name: 'Eleanor Harper', idNumber: 'DP-8821', dob: 'May 12, 1982', lastCase: 'Oct 24, 2023', active: '2 Active', activeClass: 'bg-secondary-container text-on-secondary-container', dot: 'bg-secondary' },
    { id: 'DP-9042', avatar: 'MA', avatarColor: 'bg-surface-container-highest text-on-surface-variant', name: 'Marcus Aris', idNumber: 'DP-9042', dob: 'Dec 04, 1995', lastCase: 'Nov 02, 2023', active: 'No active', activeClass: 'bg-tertiary-fixed text-on-tertiary-fixed-variant', dot: '' },
    { id: 'DP-7731', avatar: 'SL', avatarColor: 'bg-primary-container text-on-primary-container', name: 'Sarah Liao', idNumber: 'DP-7731', dob: 'Jul 28, 1974', lastCase: 'Oct 30, 2023', active: '1 Active', activeClass: 'bg-secondary-container text-on-secondary-container', dot: 'bg-secondary' },
    { id: 'DP-8119', avatar: 'JT', avatarColor: 'bg-surface-container-highest text-on-surface-variant', name: 'Julian Thompson', idNumber: 'DP-8119', dob: 'Jan 15, 2001', lastCase: 'Sep 14, 2023', active: 'No active', activeClass: 'bg-tertiary-fixed text-on-tertiary-fixed-variant', dot: '' },
    { id: 'DP-5520', avatar: 'RD', avatarColor: 'bg-error-container text-on-error-container', name: 'Rebecca Davis', idNumber: 'DP-5520', dob: 'Feb 19, 1968', lastCase: 'Oct 11, 2023', active: '3 Active', activeClass: 'bg-secondary-container text-on-secondary-container', dot: 'bg-secondary' },
  ]
      ...
      <main className="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <header className="flex justify-between items-center px-lg py-sm w-full sticky top-0 z-40 bg-surface-container-lowest border-b border-outline-variant">
          <div className="flex items-center gap-lg flex-1">
            <h2 className="font-headline-md text-headline-md font-semibold text-primary">Patient Directory</h2>
          ...
          <div className="p-lg max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-md mb-lg">
              ...
              <div className="flex items-center justify-end">
                <Link to="/admin/patients/add" className="bg-primary text-on-primary h-12 px-lg rounded-lg font-title-sm flex items-center gap-sm shadow-sm hover:brightness-110 active:scale-95 transition-all">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-outline-variant">
                    <tr className="hover:bg-surface-container transition-colors cursor-pointer group">
                      ...
                      <td className="px-lg py-md text-right">
                        <div className="flex justify-end gap-xs">
                          <Link to={`/admin/patients/DP-8821`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="View Records">
                            <span className="material-symbols-outlined text-sm">visibility</span>
                          </Link>
                          <Link to={`/admin/patients/DP-8821/edit`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="Edit Profile">
                    ...
                    <tr className="hover:bg-surface-container transition-colors cursor-pointer group">
                      ...
                      <td className="px-lg py-md text-right">
                        <div className="flex justify-end gap-xs">
                          <Link to={`/admin/patients/DP-9042`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="View Records">
                            <span className="material-symbols-outlined text-sm">visibility</span>
                          </Link>
                          <Link to={`/admin/patients/DP-9042/edit`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="Edit Profile">
                            <span className="material-symbols-outlined text-sm">edit</span>
                          </Link>
                        </div>
                      </td>
                    ...
                    <tr className="hover:bg-surface-container transition-colors cursor-pointer group">
                      ...
                      <td className="px-lg py-md text-right">
                        <div className="flex justify-end gap-xs">
                          <Link to={`/admin/patients/DP-7731`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="View Records">
                            <span className="material-symbols-outlined text-sm">visibility</span>
                          </Link>
                          <Link to={`/admin/patients/DP-7731/edit`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="Edit Profile">
                            <span className="material-symbols-outlined text-sm">edit</span>
                          </Link>
                        </div>
                      </td>
                    ...
                    <tr className="hover:bg-surface-container transition-colors cursor-pointer group">
                      ...
                      <td className="px-lg py-md text-right">
                        <div className="flex justify-end gap-xs">
                          <Link to={`/admin/patients/DP-8119`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="View Records">
                            <span className="material-symbols-outlined text-sm">visibility</span>
                          </Link>
                          <Link to={`/admin/patients/DP-8119/edit`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="Edit Profile">
                            <span className="material-symbols-outlined text-sm">edit</span>
                          </Link>
                        </div>
                      </td>
                    ...
                    <tr className="hover:bg-surface-container transition-colors cursor-pointer group">
                      ...
                      <td className="px-lg py-md text-right">
                        <div className="flex justify-end gap-xs">
                          <Link to={`/admin/patients/DP-5520`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="View Records">
                            <span className="material-symbols-outlined text-sm">visibility</span>
                          </Link>
                          <Link to={`/admin/patients/DP-5520/edit`} className="p-2 hover:bg-primary-container hover:text-on-primary-container rounded transition-all text-on-surface-variant" title="Edit Profile">
                            <span className="material-symbols-outlined text-sm">edit</span>
                          </Link>
                        </div>
                      </td>
