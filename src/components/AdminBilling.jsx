        ...
        <div className="max-w-[1600px] mx-auto">
            ...
            <header className="flex justify-between items-end mb-xl">
              <div>
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mt-1">Review financial performance and manage client receivables across all locations.</p>
              </div>
                    ...
                    <tbody className="divide-y divide-surface-container">
                      <tr className="hover:bg-surface-container transition-colors group">
                        <td className="px-md py-4">
                          <Link to={`/admin/billing/invoice/${encodeURIComponent('INV-2024-890')}`} className="font-data-tabular text-primary font-bold hover:underline">INV-2024-890</Link>
                        </td>
