                  ...
                  {casesData.map((c) => (
                    <tr key={c.id} className="hover:bg-tertiary-fixed/30 transition-colors group">
                      <td className="px-md py-4">
                        <Link to={`/cases/${encodeURIComponent(c.id)}`} className="flex items-center gap-2 text-primary hover:underline">
                      ...
                      <td className="px-md py-4">
                        <div className="flex gap-1 justify-end">
                          <button className="p-1.5 text-primary hover:bg-primary-container/10 rounded transition-colors" title="Open Details">
