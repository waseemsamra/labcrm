      ...
      <div className="flex-grow p-lg">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-xl gap-md">
            ...
            <div className="flex gap-sm">
              <Link to={`/client/PatientRecords/${patientId}/edit`} className="flex items-center gap-sm px-md py-sm bg-surface border border-outline-variant hover:bg-surface-container transition-colors rounded-lg font-label-caps text-label-caps">
          ...
          <div className="grid grid-cols-12 gap-lg">
            ...
            <div className="col-span-12 lg:col-span-8 flex flex-col gap-lg">
                ...
                <table className="w-full text-left">
                  ...
                  <tbody className="divide-y divide-surface-container-low">
                    <tr className="hover:bg-tertiary-fixed transition-colors">
                      ...
                      <td className="px-md py-md">
                        <span className="inline-flex items-center px-sm py-0.5 rounded-full text-[11px] font-bold bg-green-100 text-green-800">COMPLETED</span>
                      </td>
                    ...
                    <tr className="hover:bg-tertiary-fixed transition-colors">
                      ...
                      <td className="px-md py-md">
                        <span className="inline-flex items-center px-sm py-0.5 rounded-full text-[11px] font-bold bg-amber-100 text-amber-800">IN PRODUCTION</span>
                      </td>
                      <td className="px-md py-md text-right">
                    ...
                    <tr className="hover:bg-tertiary-fixed transition-colors">
                      ...
                      <td className="px-md py-md">
                        <span className="inline-flex items-center px-sm py-0.5 rounded-full text-[11px] font-bold bg-green-100 text-green-800">ARCHIVED</span>
                      </td>
                      <td className="px-md py-md text-right">
              ...
              <div className="grid grid-cols-2 gap-md">
                <div className="border border-outline-variant rounded-lg p-md bg-white">
